...
class Ackermann():
    def __init__(self,x,y,theta,psi,exact=False):
        self.start = [50,50,0,0]
        self.goal = [350,500,0,0]
        ...
        for v in [-v_max,v_max]:
            for psi in arange(-self.psi_max, self.psi_max + psi_increment, psi_increment): 
                ...
                for _ in range(100):                                           
                    ...
                    y = y + ydelta
                    psi = psi
                neighbors.append([x,y,theta,psi,v])
...
pygame.display.set_caption('Valet Ackermann Drive')
...
# for loop through the event queue  
    for event in pygame.event.get():
        ...
        for path in path_list:
            pygame.draw.line(screen, (0, 255, 0), path[0], path[1], width=2)
